      ...
      <div className="relative h-screen">
        ...
        <div className="relative flex flex-col items-start justify-center h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-white">
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-4">
            Discover Your <br />
            Dream Home Blueprint
          </h1>
          <p className="text-xl md:text-2xl text-gray-200 max-w-2xl mb-10">
            Premium architectural plans crafted by world-class designers, ready
          ...
          <div className="w-full max-w-xl">
            ...
            <div className="mt-6 grid grid-cols-3 gap-4">
              <Link
                to="/plans?style=modern"
                className="bg-whit black bg-opacity-10 hover:bg-opacity-20 backdrop-blur-sm rounded-lg p-3 text-center transition duration-300 shadow-md hover:shadow-lg"
              >
                Modern
              </Link>
              <Link
                to="/plans?style=craftsman"
                className="bg-whit black bg-opacity-10 hover:bg-opacity-20 backdrop-blur-sm rounded-lg p-3 text-center transition duration-300 shadow-md hover:shadow-lg"
              >
                Craftsman
              </Link>
              <Link
                to="/plans?style=farmhouse"
                className="bg-whit black bg-opacity-10 hover:bg-opacity-20 backdrop-blur-sm rounded-lg p-3 text-center transition duration-300 shadow-md hover:shadow-lg"
              >
                Farmhouse
              </Link>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              How ArchiBuild Works
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              From browsing to building, we've simplified the process of finding
              and implementing your perfect house plan.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center bg-gray-50 p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Explore our catalog of premium house plans and find the perfect
            ...
            <div className="text-center bg-gray-50 p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Personalize your plan with optional modifications or request
                custom changes.
              </p>
            </div>
            ...
            <div className="text-center bg-gray-50 p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Receive complete build-ready blueprints and bring your dream
                home to life.
              </p>
            </div>
          </div>
      ...
      <div className="relative py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Our team of architects can create a custom house plan tailored to
            your specific requirements.
          </p>
          <Link
            to="/custom"
            className="inline-block bg-primary-600 hover:bg-primary-700 text-white font-medium px-8 py-3 rounded-lg transition duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
          >
